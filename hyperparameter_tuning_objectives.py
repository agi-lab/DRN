import torch
import numpy as np
from drn import DRN, CANN, MDN, DDR, drn_loss, ddr_loss, \
        gaussian_deviance_loss, gamma_deviance_loss, \
        gaussian_mdn_loss, gamma_mdn_loss, train, crps, ddr_cutpoints, drn_cutpoints

# Objective function to minimize for CANN
def objective_cann(params, X_train, Y_train, X_val, Y_val, 
                   train_dataset, val_dataset, glm, distribution,
                   patience = 50):
